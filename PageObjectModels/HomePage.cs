...
namespace Evernote.PageObjectModels
{
    public class HomePage
    {
        ...
        readonly string create_note = "//div[@id='qa-HOME_WIDGET_CONTROL_Notes_2|0_0|0_WTFST3|13']";
        readonly string latest_note = "//article[@data-asloc='Notes']//div[@id='qa-HOME_NOTE_WIDGET_NOTE_LIST_2|0_0|0_WTFST3|13']//article[1]//span";
